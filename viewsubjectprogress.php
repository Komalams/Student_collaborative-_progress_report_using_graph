...
<html>
    <head>
        ...
        <script src="js/studentsemprogress.js"></script>
        ...
        <div id="wrapper"> 
            ...
            <div class="navigation">
                <ul>
                    ...
                    <li><a href="viewstudentreport.php" style="font-weight: bold;">SEM REPORT</a></li>
                    <li><a href="viewsubjectprogress.php" style="font-weight: bold;">SUBJECT PROGRESS</a></li>
            ...
            <div id="page_content">
                ...
                <table style="margin: auto; margin-top: 30px; " cellspacing="20">
                    ...
                    <tr>
                        <td style="font-size: 30px; font-family: monospace; font-weight: bold; color: #990000">SUBJECT NAME
                        </td>
                ...
                if (isset($_REQUEST['sem'])) {
                    $subjlectid = 0;
                    $query = "SELECT subjectlectureid , subjectname FROM subjectlecture INNER JOIN SUBJECT ON subject.subjectid = subjectlecture.subjectid WHERE semester = '$sem'";
                    $result = $conn->query($query);
                    ...
                    $query = "SELECT regno , marks FROM marks WHERE subjectlectureid = (SELECT subjectlectureid FROM subjectlecture WHERE subjectid = $subid AND iatype = $selectedIA)";
                    //echo $query;
                    $result = $conn->query($query);
                    $i = 0;
                    if ($result->num_rows > 0) {
...
?>
                ...
                <div id="chartContainer"
                     style="height: 370px; width: 80%; margin-left: 80px; margin-top: 20px;"></div>
                <div class="clear"></div>
