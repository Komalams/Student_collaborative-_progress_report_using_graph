...
<html>
    <head>
        ...
        <script src="js/managestaffmarks.js" type="text/javascript"></script>
    </head>
    <body>
        <div id="wrapper"> 
            <div id="header">
            ...
            <div id="page_content">
                ...
                <form action=""  onsubmit="return validate();" method="">
                    <table style="margin: auto; margin-top: 5px;" cellspacing="20;" >
                        <thead>
                            <tr>
                                <td colspan="2"
                        ...
                        if (isset($_REQUEST['iatype'])) {
                            ?>
                            <tr>
                                <td style="font-weight: bold; font-size: 15px; color: blue;">STUDENT
                                    NAME</td>
                                <td style="font-weight: bold; font-size: 15px; color: blue;">MARKS
                                </td>
                            </tr>
                            <?php
                        ...
                        ?>						
                        <tr><td><a href="managestaffmarks.php" style="font-size: 15px; font-weight: bold" > CANCEL </a></td>
